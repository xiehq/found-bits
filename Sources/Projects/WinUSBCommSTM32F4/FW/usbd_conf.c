/**
  ...
  * @brief   This file implements the USB Device library callbacks and WinUSBComm
  ******************************************************************************
  * @attention
  *
...
// Host Controller Driver (HCD); Peripheral Controller Driver (PCD)
...
/**
  * @brief  Initializes the PCD WinUSBComm.
...
/**
  * @brief  De-Initializes the PCD WinUSBComm.
  * @param  hpcd: PCD handle
  * @retval None
  */
